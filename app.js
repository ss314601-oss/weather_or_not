document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchForecastData() {
        const url = `https://api.open-meteo.com/v1/forecast?latitude=${currentLat}&longitude=${currentLon}&hourly=temperature_2m,precipitation&models=${models.map(m=>m.id).join(',')}&forecast_days=7&timezone=auto`;
